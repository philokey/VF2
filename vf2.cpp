#include "vf2.h"
#include <iostream>
void getCandidatePairs(const Graph &g1, const Graph &g2, State &s) {
...
bool getFsem(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
...
bool calRpred(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
...
bool calRsucc(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
    unordered_set<int> interSt;
...
bool calRin(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
...
bool calRout(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
    unordered_set<int> interSt1, interSt2;
...
bool calRnew(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
    //return true;
    unordered_set<int> interSt1, interSt2;
...
bool getFsyn(const Graph &g1, const Graph &g2, const State &s, int n, int m) {
...
void updateTin(const Graph &g, unordered_set<int> &Tin, unordered_set<int> &FN, int u, const vector<int> &core) {
    int v;
...
void updateTout(const Graph &g, unordered_set<int> &Tout, unordered_set<int> &FN, int u, const vector<int> &core) {
    int v;
...
State updateState(const Graph &g1, const Graph &g2, State s, int n, int m) {
    s.M1.insert(n);
    s.M2.insert(m);
...
bool match(const Graph &g1, const Graph &g2, State &s) {
